...
} = require('../../middleware/provider/github/collectEnvirementData.middleware');
const {
  getAccessGithub,
} = require('../../middleware/provider/github/auth/getToken.middleware');
const {
  updateCompanyProviderList,
} = require('../../middleware/provider/github/auth/updateCompanyProviderList.middelware');
const redirectToURL = require('../../controller/company/companyAuth/createProvider.controller');
const {
  createProvider,
} = require('../../middleware/provider/github/auth/saveProvider.middleware');
const {
  getUserDetailsByEmail,
} = require('../../middleware/user/details/getUserDetails.middleware');
const {
  populateUser,
