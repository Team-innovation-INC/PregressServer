...
router.post( "/create", createCompanyInputs, validateInputs, checkCompanyExist, populateUser, createTokenCompany, (req, res) => { res.status(200).send("create a new company");});
