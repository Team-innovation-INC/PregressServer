...
const defaultValues = _path => {
  switch (_path) {
    ...
    case 'roleName':
      return {
        Enumerator: ['super-admin', 'admin', 'moderator', 'user'],
        default: 'user',
      };
    case 'email':
    ...
    case 'pic':
      return {
        type: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTAzw8Q6UOf1CL3h4y3EkHM0qCE47S_-AyxAQ&usqp=CAU',
      };
    case 'blocked':
      return { type: false };
    case 'companyWebSite':
      return { type: 'url', example: 'http://localhost:3000' };
    case 'creationDate':
      return { type: '2023-04-17T00:05:29.527+00:00' };
